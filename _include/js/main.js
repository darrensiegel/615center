...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											...
											{image : '_include/img/slider-images/2.jpg', title : '<div class="slide-content">Open House<br>September 12th & 13th&nbsp;&nbsp;1 - 4pm</div>', thumb : '', url : ''},	],
...
CHAKRA.map = function(){
	if($('.map').length > 0)
	{
		...
		$('.map').each(function(i,e){
			...
			var contentString = '<p><strong>615 Center Ave</strong><br>Aspinwall, PA 15215</p>';
